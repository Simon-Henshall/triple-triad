...
-- ============================================================
-- This script creates the `card`, `element`, and `player_card`
-- tables and inserts every card defined in
-- front_end/js/data/cards.js with image associations.
-- ============================================================
...
-- ------------------------------------------------------------
-- 2. Player-Card junction table (referenced in Card.php)
--     Tracks which players own which cards.
-- ------------------------------------------------------------
