...
Game.utils = {
  ...
  pickPlayerCards(ownedCardsJSON) {
    ...
    Game.ui.selectionBoard.displayedCard = null;
    ...
    if (Game.rules.indexOf("random") != -1) {
      ...
      Game.ui.selectionBoard.background = new createjs.Shape();
      Game.ui.selectionBoard.background.graphics
        .beginFill("#666666")
        .drawRect(0, 0, 420, 450);
      Game.ui.selectionBoard.background.x = 170;
      Game.ui.selectionBoard.background.y = 100;
      Game.ui.selectionBoard.container.addChild(Game.ui.selectionBoard.background);

      // Draw the selection board text
      var cardListText = new createjs.Text("CARDS", "20px Arial", "#ffffff");
      cardListText.x = Game.ui.selectionBoard.background.x + 10;
      cardListText.y = Game.ui.selectionBoard.background.y + 20;
      cardListText.textBaseline = "alphabetic";

      var pageText = new createjs.Text("P.", "20px Arial", "#ffffff");
      pageText.x = Game.ui.selectionBoard.background.x + 110;
      pageText.y = Game.ui.selectionBoard.background.y + 20;
      pageText.textBaseline = "alphabetic";

      // Game.ui.pageDisplay should be a createjs.Text object
      Game.ui.selectionBoard.pageDisplay = new createjs.Text("1", "20px Arial", "#ffffff");
      Game.ui.selectionBoard.pageDisplay.x = Game.ui.selectionBoard.background.x + 150;
      Game.ui.selectionBoard.pageDisplay.y = Game.ui.selectionBoard.background.y + 20;
      Game.ui.selectionBoard.pageDisplay.textBaseline = "alphabetic";

      var numText = new createjs.Text("NUM.", "20px Arial", "#ffffff");
      numText.x = Game.ui.selectionBoard.background.x + 350;
      numText.y = Game.ui.selectionBoard.background.y + 20;
      numText.textBaseline = "alphabetic";

      Game.ui.selectionBoard.container.addChild(
        cardListText,
        pageText,
        Game.ui.selectionBoard.pageDisplay,
        numText
      );
      ...
      if (Game.ui.selectionBoard.container.parent) {
        Game.ui.selectionBoard.container.parent.removeChild(Game.ui.selectionBoard.container);
      }
      Game.stage.addChild(Game.ui.selectionBoard.container);
